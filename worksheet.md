...
- The text is scrolling using the default colour white. Could you add some code to change the colours? See the [getting started with sense hat resource here](https://www.raspberrypi.org/learning/getting-started-with-sense-hat/worksheet/) to help.
